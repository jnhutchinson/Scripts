...
Bpipe.run {makefilelist + "%.fastq" * [ mkfastqcdirs + fastqc_pretrim + trim_galore + bismarkalign + bseqc + dedupfilename + makebam + addreadgroups + reorder_contigs + dedupe + indexbam + count_covars + write_recal_BQscore_toBAM + call_meth]}
